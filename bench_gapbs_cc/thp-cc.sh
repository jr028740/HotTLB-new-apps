...
OUTPUT_FILE="$DATAPATH/cc.out.$DATETIME.thp"
...
./switch_bench_profile.sh thp cc
...
echo "GAPBS CC THP started with PID $CC_PID"
...
echo "GAPBS CC THP exit status: $CC_STATUS"
