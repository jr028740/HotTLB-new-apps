...
PMDMON_START="$HOTTLB_DIR/pmdmon_start_hottlb_rocksdb"
...
echo "RocksDB HotTLB started with PID $DBBENCH_PID"
...
datapath="$DATAPATH" \
datetime="$DATETIME" \
"$PERF_SCRIPT" rocksdb-hottlb "$DBBENCH_PID" &
...
echo "RocksDB HotTLB exit status: $DBBENCH_STATUS"
echo "Output: $OUTPUT_FILE"
echo "Done."
